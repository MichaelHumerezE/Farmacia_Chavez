...
<head>
    ...
    <title>Farmacia Chávez - Web</title>
                    ...
                    <div class="col-md-6">
                        <div class="header-search">
                            <form action="{{ route('search') }}" method="POST" id="search">
                                @csrf
                                <select class="input-select" name='atributo'>
                                    <option value="name">Nombre</option>
                                    <option value="precioUnitario">Precio</option>
                                </select>
                                <input class="input" placeholder="Search here" name="valor">
                                <button class="search-btn" form="search">Search</button>
                            </form>
                        </div>
                    </div>
                    <!-- /SEARCH BAR -->
                                                        ...
                                                        @if ($detalleCarrito->idProducto == $producto->id)
                                                            ...
                                                            <div class="product-widget">
                                                                ...
                                                                <div class="product-body">
                                                                    <h3 class="product-name"><a href="{{ route('catalogo.show', $producto->id) }}">
                                                                            {{ $producto->name }}</a></h3>
